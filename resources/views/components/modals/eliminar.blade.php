<dialog id="modal_eliminar" class="modal">
    <div class="modal-box bg-white dark:bg-gray-800 text-gray-900 dark:text-white rounded-md">
        <form wire:submit.prevent="eliminar()" id="form-eliminar">
            <div class="p-2 md:p-2 text-center">
                <svg class="mx-auto mb-4 text-gray-400 w-12 h-12 dark:text-gray-200" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 11V6m0 8h.01M19 10a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
                </svg>
                <h3 class=" text-lg font-normal text-gray-500 dark:text-gray-400">¿Está seguro de eliminar el registro?</h3>
            </div>
        </form>
        <div class="modal-action flex justify-center gap-8">
            <form class="gap-4">
                    <button type="submit" form="form-eliminar"
