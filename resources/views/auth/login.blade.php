...
<body>
    ...
    <div class="pt-16">
        <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
            ...
            <form method="POST" action="{{ route('loginUser') }}" class="w-full p-8 lg:w-1/2">
                @csrf
                <h2 class="text-2xl font-semibold text-gray-700 text-center">HGS</h2>
                ...
                <div class="mt-8">
                    <button type="submit"
                        class="bg-gray-700 text-white font-bold py-2 px-4 w-full rounded hover:bg-gray-600">Ingresar</button>
                </div>
