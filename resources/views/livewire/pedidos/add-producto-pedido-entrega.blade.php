 ...
 <div id="modal-editar-detalle" tabindex="-1" aria-hidden="true"
     ...
     <div class="relative p-4 w-full h-full flex justify-center items-center">
         ...
         <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-800 w-2/5">
             <!-- Modal body -->
             <div class="mb-6 p-5">
                 <h3 class="text-lg font-bold mb-6 text-md text-gray-900 dark:text-white">Agregar Producto al Pedido</h3>

                 <label for="first_name" class="block mb-2 text-md font-medium text-gray-900 dark:text-white">
                     Pedido</label>
                 <input type="text" id="first_name" wire:model="numero_pedido" value="{{ $numero_pedido }}"
                 ...
                 <div class="mt-3">
                     ...
                     <select id="countries" wire:model="producto_id"
                         class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                         required>
                         <option selected disabled>Seleccione</option>
                         @foreach ($productosSinAgregar as $item)
             ...
             <div
                 ...
                 <button type="button" wire:click="$set('nuevoProducto', false);"
                     class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Cancelar</button>
                 <button data-modal-hide="modal-editar-detalle" type="button" wire:click="agregarNuevoProducto()"
